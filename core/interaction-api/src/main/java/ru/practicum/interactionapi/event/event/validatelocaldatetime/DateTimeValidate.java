package ru.practicum.interactionapi.event.event.validatelocaldatetime;

import jakarta.validation.Constraint;
import jakarta.validation.Payload;
import ru.practicum.interactionapi.event.event.validatelocaldatetime.checktimedifference.DateTimeValidateImpl;
